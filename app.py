...
@st.cache_data
def load_files():
    df_cleaned = pd.read_csv("D:\\GUVI - Project 4\\data\\cleaned_data.csv")
    df_encoded = pd.read_csv("D:\\GUVI - Project 4\\data\\encoded_data.csv")
    with open("D:\\GUVI - Project 4\\data\\encoder.pkl", "rb") as f:
